...
public interface TimeSlotRepository extends JpaRepository<TimeSlot, Integer> {
    ...
    /**
     * Tìm tất cả các TimeSlot của một sân cụ thể trong phạm vi một ngày, sắp xếp theo thời gian bắt đầu.
     */
    ...
    List<TimeSlot> findSlotsByCourtAndDate(
    ...
    /**
     * Kiểm tra xem một khung giờ với thời gian bắt đầu cụ thể đã tồn tại cho một sân hay chưa.
     * Dùng để tránh tạo trùng lặp.
     * @return true nếu đã tồn tại, false nếu chưa.
     */
    boolean existsByCourtIdAndStartTime(Integer courtId, LocalDateTime startTime);
